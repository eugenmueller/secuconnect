RSpec.describe Secuconnect::Oauth2::Token, vcr: true do
  it { expect(described_class.new).to respond_to(:find_or_create) }

  describe '.find_or_create' do
    context 'with valid credentials and not cached token' do
      let(:token) { described_class.new.find_or_create }
    ...
    context 'with valid credentials' do
      ...
      it 'raise an error' do
        ...
        expect { described_class.new.find_or_create }.to raise_error(StandardError)
      end
    end
  end
end